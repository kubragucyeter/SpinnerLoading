...
function sendTextToAPI(text, successCallback, failureCallback, errorCallback) {
    ...
    $.ajax({
        ...
        dataType: "json",
        headers: { 
            "Authorization": "Bearer gD5aFDdmItmovC6hxVFQ3JtKd-TzqHURjuWYGEEcTI-vmhgKKPMF8RsKlbyOzi38jNb4nxPqdcg46I9xIji5rZyXT4SynnuQHkXCz1etlRt8Kc9TMrD4fcm0PJI4DZV0yZCZnpK1QkDEbCR0Md78mF8YCY2fkiLeYORwT0BBOllykWKcp28ef4ADG4W_2YJsigOR8fa73hd5GFFghNBxwIjJi4qCpEJDFrvtW2SCLKRbu3rwEhGT6TyqYw7AkGoLYbkKwX7VOSBauTJ007pDfxYUHwUS3UgSwdzJ9fYqlxwd3GjgAhI6PinlZCLs8GcVHQUbZGTno8YIFJRurKP2DQ" 
        },
        success: function (response) {
